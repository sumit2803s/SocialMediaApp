...
public class SocialMediaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private String imageIndentifier;
    ...
    private void uploadImagetoserver(){
        ...
        if(bitmap!=null) {
            ...
            imageIndentifier = UUID.randomUUID() + ".png";

            UploadTask uploadTask = FirebaseStorage.getInstance().getReference().child("my_images").child(imageIndentifier).putBytes(data);
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    // ...
                    Toast.makeText(SocialMediaActivity.this, "Uploading process was Successfull", Toast.LENGTH_LONG).show();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        datamap.put("imageIdentifier",imageIndentifier);
